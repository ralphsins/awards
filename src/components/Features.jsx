      ...
      <div className="container mx-auto px-3 md:px-10">
        ...
        <div className="grid h-[135vh] grid-cols-2 grid-rows-3 gap-7">
          ...
          <BentoTilt className="bento-tilt-2">
            <div className="flex size-full rounded-md flex-col justify-between bg-violet-300 p-5">
          ...
          <BentoTilt className="bento_tilt_2 rounded-md">
            <video
              src="/videos/feature-5.mp4"
              loop
              muted
              autoPlay
              className="size-full object-cover object-cente rounded-md"
            />
          </BentoTilt>
        </div>
      </div>
